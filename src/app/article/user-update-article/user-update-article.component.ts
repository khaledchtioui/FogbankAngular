...
@Component({
  selector: 'app-user-update-article',
  templateUrl: './user-update-article.component.html',
  styleUrls: ['./user-update-article.component.css'],
})
export class UserUpdateArticleComponent implements OnInit {
  constructor(
