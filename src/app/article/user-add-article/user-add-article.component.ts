...
@Component({
  selector: 'app-user-add-article',
  templateUrl: './user-add-article.component.html',
  styleUrls: ['./user-add-article.component.css'],
})
export class UserAddArticleComponent implements OnInit {
  constructor(
          ...
          this.articleService
            ...
            .subscribe({
              next: (res) => {
                ...
                console.log(res);
                this.router.navigate(['/user/allarticle']);
              },
              error: (err) => {
                // console.log(err);
              },
